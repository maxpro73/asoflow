...
import { getEmployeeById, updateEmployee } from "@/lib/employee-store"
...
export function EditEmployeeModal({ open, onOpenChange, employeeId }: EditEmployeeModalProps) {
    ...
    if (open && employeeId) {
      ...
      if (employee) {
        setFormData({
          ...
          lastAsoDate: employee.lastAsoDate,
          periodicity: employee.periodicity,
        })
      } else {
        setFormData((prev) => ({
          ...prev,
          department: companyConfig.departments[0] || "",
        }))
      }
      setErrors({})
    }
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                {companyConfig.departments.map((dept) => (
