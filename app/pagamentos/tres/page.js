  ...
  <div className="min-h-screen bg-white flex flex-col items-center justify-center">
    <div className="text-center">
      ...
      <p className="text-gray-600 mb-8">
        Preparando tudo para sua assinatura profissional
      </p>
...
export default function PagamentosTresPage() {
  ...
  useEffect(() => {
    ...
    if (data) {
      try {
        ...
        console.log('✅ Dados carregados para plano Profissional:', parsedData.email);
      } catch (error) {
        console.error('❌ Erro ao parsear dados:', error);
        setErrorMessage('Erro ao carregar dados. Por favor, recarregue a página.');
      }
    } else {
      console.log('⚠️ Nenhum dado encontrado para plano Profissional');
  ...
  const planoInfo = {
    ...
    name: 'Profissional',
    monthlyValue: 397.00,
    annualValue: 337.00 * 12,
    descricao: 'Plano Profissional - Solução completa para grandes empresas',
    beneficios: [
      'Até 200 funcionários',
      '10 usuários RH',
      '5 unidades/empresas',
      'Alertas Email + Whatsapp + SMS + Push',
      'Dashboard Empresarial',
      'Histórico de alertas (36 meses)',
  ...
  const createMercadoPagoPreference = async () => {
    try {
      ...
      console.log('🔄 Preparando dados para Mercado Pago (Profissional):');
            ...
            <div className="max-w-md mx-auto mb-12">
              <div className="grid grid-cols-2 gap-6">
                ...
                >
                  ...
                  <div className="mb-2">
                    <span className="text-2xl font-bold text-gray-900">R$ 337,00</span>
                    <span className="text-gray-600">/mês</span>
                  </div>
                  <p className="text-sm text-gray-600">
                    <span className="line-through text-gray-400">R$ {planoInfo.monthlyValue.toFixed(2)}</span>
                    {' '}
                    <span className="text-green-600 font-medium">R$ 337,00</span>
                  </p>
                </button>
              </div>
            </div>
                  ...
                  <div className="bg-gradient-to-b from-blue-50 to-white border border-blue-200 rounded-2xl p-8 shadow-sm sticky top-8">
                      ...
                      {planType === 'annual' && (
                        <>
                          ...
                          <div className="flex justify-between mb-2">
                            ...
                            <span className="text-gray-900">R$ 337,00</span>
                          </div>
                        </>
                      )}
                    ...
                    <div className="mt-8 bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-xl p-4">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                          <h4 className="text-gray-900 font-semibold">SLA 99.9%</h4>
                          <p className="text-sm text-gray-600">Disponibilidade garantida</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="lg:col-span-2">
                  ...
                  <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg mb-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-8">
                      ...
                      >
                        ...
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Outras</h4>
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-8 mb-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      {[
                        { icon: Zap, title: 'Alta Performance', desc: 'Grandes volumes' },
                        { icon: Users, title: 'Multi-usuários', desc: '10 usuários RH' },
                        { icon: BarChart3, title: 'Dashboard', desc: 'Análises avançadas' },
                        { icon: Globe, title: 'Multi-unidades', desc: '5 empresas' },
                        { icon: Cloud, title: 'Backup', desc: 'Nuvem dedicada' },
                  ...
                  {/* Lista Completa */}
                  <div className="mb-8">
                    <h3 className="text-xl font-bold text-gray-900 mb-4">Tudo incluído:</h3>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-blue-100 text-sm">
                          Plano desenvolvido para grandes empresas. Após o pagamento, 
                          sua conta será criada automaticamente com todos os recursos.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Sistema de Gestão de ASO Profissional
              </p>
            </div>
